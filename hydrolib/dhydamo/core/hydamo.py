...
class Network:
    ...
    def generate_1dnetwork_old(
        ...
        structures = self.hydamo.structures.as_dataframe(
    ...
    def _generate_1d_spacing(
        self, anchor_pts: list, one_d_mesh_distance: float
    ) -> np.array:
        """
